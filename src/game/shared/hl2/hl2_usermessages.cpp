...
void RegisterUserMessages( void )
{
	...
	usermessages->Register("OpenHorseSelect", -1);
	usermessages->Register("HRActivateElement", -1);
	usermessages->Register("HRSetWinHorse", -1);
	usermessages->Register("ToggleHorseSelect", -1);
